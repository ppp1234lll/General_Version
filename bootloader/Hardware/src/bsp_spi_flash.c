/*
*********************************************************************************************************
*    函 数 名: SPI接口串行FLASH 读写模块
*    功能说明: bsp_spi_flash.c
*    形    参: V1.0
*    返 回 值: 支持 SST25VF016B、MX25L1606E 和 W25Q64JV/BV
...
#define SF_CS_CLK                     RCU_GPIOD
#define SF_CS_GPIO                    GPIOD
#define SF_CS_PIN                     GPIO_PIN_7

#define SF_CS_0()                     gpio_bit_reset(SF_CS_GPIO,SF_CS_PIN);
#define SF_CS_1()                     gpio_bit_set(SF_CS_GPIO,SF_CS_PIN);
...
void bsp_InitSFlash(void)
{
    ...
    {
        /* 打开GPIO时钟 */
        rcu_periph_clock_enable(SF_CS_CLK);
        
        SF_CS_1();        /* 设置片选为高电平，防止初始化时产生向下的跳变沿 */
