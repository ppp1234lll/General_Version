...
#define LIS3DH_XOR                                     LIS3DH_BIT(4)
#define LIS3DH_ZYXDA                                   LIS3DH_BIT(3)
#define LIS3DH_ZDA                                     LIS3DH_BIT(2)
#define LIS3DH_YDA                                     LIS3DH_BIT(1)
...
#define LIS3DH_ZLIE                                    LIS3DH_BIT(4)
#define LIS3DH_YHIE                                    LIS3DH_BIT(3)
#define LIS3DH_YLIE                                    LIS3DH_BIT(2)
#define LIS3DH_XHIE                                    LIS3DH_BIT(1)
#define LIS3DH_XLIE                                    LIS3DH_BIT(0)

//FIFO CONTROL REGISTER
#define LIS3DH_FIFO_CTRL_REG                           0x2E
#define LIS3DH_FM                                      LIS3DH_BIT(6)
#define LIS3DH_TR                                      LIS3DH_BIT(5)
#define LIS3DH_FTH                                     LIS3DH_BIT(0)
