...
/*
	4、输入检测
		    ...
		    水浸 :                 PD14
*/
#define RESET_K1_PIN              GPIO_PIN_8                
#define RESET_K1_GPIO_PORT        GPIOA                      
#define RESET_K1_GPIO_CLK         RCU_GPIOA

#define DOOR_K2_PIN               GPIO_PIN_13                 
#define DOOR_K2_GPIO_PORT         GPIOD                      
#define DOOR_K2_GPIO_CLK          RCU_GPIOD

#define PWR_K3_PIN               GPIO_PIN_5                
#define PWR_K3_GPIO_PORT         GPIOA                      
#define PWR_K3_GPIO_CLK          RCU_GPIOA

#define WATER_K4_PIN             GPIO_PIN_14                
#define WATER_K4_GPIO_PORT       GPIOD                      
#define WATER_K4_GPIO_CLK        RCU_GPIOD
 ...
 */
const combo_config_t combo_keys_config_list[1] = {0
    // 示例：四个组合键
    //         组合键ID,    按键1, 按键2, ..., 按键N
 ...
 */
const special_key_list_t special_keys_list[1] = {0
    /* --------------------------------- 此处配置需要单独参数的按键 -------------------------------- */
    // 示例：只配置需要单独参数的按键
 ...
 */
const special_combo_key_list_t special_combo_keys_list[1] = {0
    /* --------------------------------- 此处配置需要单独参数的组合键 -------------------------------- */
    // 示例：只配置需要单独参数的组合键
