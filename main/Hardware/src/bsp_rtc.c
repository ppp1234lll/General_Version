...
*********************************************************************************************************
*    函 数 名: RTC实时时钟驱动文件
*    功能说明: 基于STM32的RTC驱动，支持时间/日期设置、读取、闹钟配置及唤醒定时器功能
*    形    参: ZHLE
*    返 回 值: 
*********************************************************************************************************
*/
...
*    形    参: 
*    返 回 值: 小时（12小时制：1-12；24小时制：0-23，需配合HourFormat）
*    @min        : 分钟（0-59）
*    @sec        : 秒钟（0-59）
...
*    形    参: 
*    返 回 值: rtc_time_t类型结构体，包含时间日期信息
...
*    功能说明: 读取当前RTC时间和日期
*    形    参: 
*    返 回 值: 指向rtc_time_t类型的指针，用于存储读取到的时间日期
...
*    形    参: 
*    返 回 值: 时间数组，格式为[年,月,日,时,分,秒]（年为4位完整年份，如2024）
...
*    形    参: 
*    返 回 值: 指向rtc_time_t的指针，用于存储转换后的UTC时间
...
*    形    参: 
*    返 回 值: Unix时间戳（从1970-01-01 00:00:00 UTC开始的秒数）
*    返 回 值: 无
*********************************************************************************************************
*/
