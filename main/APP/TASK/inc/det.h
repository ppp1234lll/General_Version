...
typedef enum
{
    NET_STATUS_NO_IP  = 0,   // 无IP
    NET_STATUS_NORMAL = 1,   // 网络正常
    NET_STATUS_FAULT  = 2,   // 网络故障
    NET_STATUS_DELAY  = 4,   // 网络延时
    NET_STATUS_LOSS   = 5,   // 丢包
}NET_STATUS_E;
...
typedef struct
{
    ...
    uint8_t camera[6];       // 摄像机网络状态：0-无IP 1-正常 2-故障 4-延时 5-丢包
    uint8_t main_ip;         // 主网络状态：   0-无IP 1-正常 2-故障 4-延时 5-丢包
    uint8_t main_sub_ip;     // 主网络2状态：  0-无IP 1-正常 2-故障 4-延时 5-丢包
