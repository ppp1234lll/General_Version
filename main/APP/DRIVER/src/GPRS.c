...
/* 控制IO */
#define GPRS_NRST_GPIO_CLK		RCU_GPIOE
#define GPRS_NRST_GPIO 				GPIOE
#define GPRS_NRST_PIN  				GPIO_PIN_10

#define GPRS_PWRK_GPIO_CLK		RCU_GPIOE
#define GPRS_PWRK_GPIO 				GPIOE
#define GPRS_PWRK_PIN 				GPIO_PIN_12

#define GPRS_CTRL_GPIO_CLK		RCU_GPIOE
#define GPRS_CTRL_GPIO 				GPIOE
#define GPRS_CTRL_PIN 				GPIO_PIN_7
...
#define GPRS_Sel_H gpio_bit_set(GPRS_Sel_GPIO,GPRS_Sel_PIN)
#define GPRS_Sel_L gpio_bit_reset(GPRS_Sel_GPIO,GPRS_Sel_PIN)

/* 串口初始化 */
#define GPRS_BAUDRATE            (115200)
#define GPRS_UART_INIT(baudrate) bsp_InitUsart0(baudrate)
#define GPRS_STR_SEND(data,len)  usart0_send_str(data,len)
////
