...
#define NET_LAN_PORT                (ERR_TYPE_NET_BASE | (1UL << 20))   // LAN端口故障
#define NET_MAIN_IP                 (ERR_TYPE_NET_BASE | (2UL << 20))   // 主IP故障
#define NET_SINGLE_IP               (ERR_TYPE_NET_BASE | (3UL << 20))   // 单IP故障
#define NET_MAIN_IP_DELAY           (ERR_TYPE_NET_BASE | (4UL << 20))   // 主IP延时
#define NET_SINGLE_IP_DELAY         (ERR_TYPE_NET_BASE | (5UL << 20))   // 单IP延时
#define NET_CAREMA1_FAULT           (ERR_TYPE_NET_BASE | (6UL << 20))   // 摄像机1故障
#define NET_CAREMA2_FAULT           (ERR_TYPE_NET_BASE | (7UL << 20))   // 摄像机2故障
#define NET_CAREMA3_FAULT           (ERR_TYPE_NET_BASE | (8UL << 20))   // 摄像机3故障
#define NET_CAREMA4_FAULT           (ERR_TYPE_NET_BASE | (9UL << 20))   // 摄像机4故障
#define NET_CAREMA5_FAULT           (ERR_TYPE_NET_BASE | (10UL << 20))  // 摄像机5故障
#define NET_CAREMA6_FAULT           (ERR_TYPE_NET_BASE | (11UL << 20))  // 摄像机6故障
#define NET_MAIN2_FAULT             (ERR_TYPE_NET_BASE | (12UL << 20))  // 主IP2故障
